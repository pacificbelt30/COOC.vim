...
"コメントアウト関数
"二重読み込み回避
if exists('g:loaded_easyCOvim')
  finish
endif
let g:loaded_easyCOvim = 1
"コメントアウトコマンドを定義
command! -nargs=? CommentOut call easyCO#Com(<f-args>)
"Space+cでコメントアウト
...
command! -range -nargs=0 UnCommentOut <line1>,<line2> call easyCO#Ucom()
"Space+Cでコメントアウトアウト
